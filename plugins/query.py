...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/tamilblasterslinkz")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('ɪɴꜱᴛᴀɢʀᴀᴍ', url='https://www.instagram.com/kavin._edits?igsh=MXVkejV1YXZycmxkaA==')
            ],[
